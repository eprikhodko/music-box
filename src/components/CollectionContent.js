...
function CollectionContent({ componentsCount, setComponentsCount }) {
  ...
  return (
    <>
      ...
      {albumsInUserCollection.length > 0 ? (
        ...
        <StyledParagraph>
          There is no albums in your collection yet. Would you like to add some
...
CollectionContent.defaultProps = {
  componentsCount: "",
}
